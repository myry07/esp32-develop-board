...
static esp_err_t create_dir_if_not_exist(const char *path)
{
    struct stat st;
...
static esp_err_t create_file(const char *file, const char *data)
{
...
static esp_err_t create_file_and_folder(const char *file, const char *data, const char *folder)
{
    char path[128];
